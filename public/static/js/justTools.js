...
(function($) {
    ...
    justTools.prototype = {
        ...
        setConfirmEvents:function(){
            var that = this;
            var yes = this.obj.find(".b-yes");
            var no = this.obj.find(".b-no");
            yes.click(function(){
        ...
        addConfirm:function(){
            this.obj.append("<div class='just-confirm'><button type='button' class='btn btn-default btn-xs b-yes'>"
                + this.set.yes +"</button><button type='button' class='btn btn-default btn-xs b-no'>" + this.set.no +"</button></div>");
